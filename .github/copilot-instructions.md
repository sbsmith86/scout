# Scout — Copilot Instructions

This file gives Copilot full context on Scout so it can assist without re-litigating decisions already made. Read it before suggesting anything architectural.
