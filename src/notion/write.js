...
async function appendOpportunity(opportunity) {
  ...
  await notion.pages.create({
    ...
    properties: {
      ...
      'Contact Name':     text(opportunity.contact_name),
      'Contact Title':    text(opportunity.contact_title),
      'Contact Email':    text(opportunity.contact_email),
      'Contact LinkedIn': text(opportunity.contact_linkedin),
      'Application Type': text(opportunity.application_type),
      'Application Notes':text(opportunity.application_notes),
...
async function appendLead(lead) {
  ...
  await notion.pages.create({
    ...
    properties: {
      ...
      'Contact Name':     text(lead.contact_name),
      'Contact Title':    text(lead.contact_title),
      'Contact Email':    text(lead.contact_email),
      'Contact LinkedIn': text(lead.contact_linkedin),
